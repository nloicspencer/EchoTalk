const fs = require('fs');
const p = 'src/app/(tabs)/zdecouverte.tsx';
...
"",
"const CATEGORIES = [",
"  { id: '1', label: 'Anxiete', icon: '\u{1F300}', color: '#FFD180' },",
"  { id: '2', label: 'Deuil', icon: '\u{1F56F}', color: '#B0BEC5' },",
"  { id: '3', label: 'Joie', icon: '\u{2728}', color: '#FFF176' },",
"  { id: '4', label: 'Colere', icon: '\u{1F525}', color: '#FF8A80' },",
"  { id: '5', label: 'Solitude', icon: '\u{1F319}', color: '#CE93D8' },",
"  { id: '6', label: 'Espoir', icon: '\u{1F331}', color: '#A5D6A7' },",
"];",
"",
"const EMOTIONS = [",
"  { id: 'sad', label: 'Triste', emoji: '\u{1F614}', color: '#90CAF9' },",
"  { id: 'angry', label: 'En colere', emoji: '\u{1F624}', color: '#FF8A80' },",
"  { id: 'anxious', label: 'Anxieux', emoji: '\u{1F62F}', color: '#FFD180' },",
"  { id: 'loving', label: 'Amour', emoji: '\u{1F970}', color: '#F48FB1' },",
"  { id: 'happy', label: 'Joyeux', emoji: '\u{1F389}', color: '#FFF176' },",
"  { id: 'hopeful', label: 'Plein espoir', emoji: '\u{1F331}', color: '#A5D6A7' },",
"];",
"",
"const TAGS = ['#solitude', '#guerison', '#therapie', '#famille', '#travail', '#identite', '#deuil', '#anxiete'];",
"",
"const ECHOS = [",
"  { id: '1', author: 'Marie L.', avatar: 'M', content: 'Petite victoire du jour. Je suis sortie du lit malgre tout.', emotion: 'hopeful', emoji: '\u{1F331}', tags: ['#petitesvictoires'], time: '2h', likes: 24, comments: 8 },",
"  { id: '2', author: 'Thomas R.', avatar: 'T', content: \"L'anxiete ce matin etait forte mais j'ai respire et ca a aide.\", emotion: 'anxious', emoji: '\u{1F62F}', tags: ['#anxiete', '#respiration'], time: '4h', likes: 31, comments: 12 },",
"  { id: '3', author: 'Sofia M.', avatar: 'S', content: 'Parfois je me demande si je vais trouver ma place.', emotion: 'sad', emoji: '\u{1F614}', tags: ['#solitude', '#identite'], time: '6h', likes: 47, comments: 19 },",
"];",
"",
...
"        <Text style={styles.title}>\u{1F50D} Decouverte</Text>",
"",
...
"                <Text style={styles.actionBtn}>\u{2764} {echo.likes}</Text>",
"                <Text style={styles.actionBtn}>\u{1F4AC} {echo.comments}</Text>",
"                <Text style={styles.actionBtn}>\u{1F503} Partager</Text>",
"              </View>",
"            </View>",
"          ))",
"        )}",
...
console.log('OK - ' + lines.length + ' lignes ecrites');
