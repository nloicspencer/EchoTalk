    ...
    <SafeAreaView style={styles.safe} edges={['top']}>
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.searchBar}>
          ...
          <TextInput style={styles.searchInput} placeholder="Échos, émotions, personnes…" placeholderTextColor="#aaa" value={query} onChangeText={setQuery} />
        </View>
        ...
        <View style={styles.popularItem}>
          ...
          <View style={styles.popularContent}>
            <Text style={styles.popularText} numberOfLines={2}>"Après des mois de silence, j'ai enfin parlé à ma famille…"</Text>
...
const styles = StyleSheet.create({
  ...
  searchBar: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#fff', borderRadius: 14, paddingHorizontal: 14, paddingVertical: 10, marginBottom: 20, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.06, shadowRadius: 6, elevation: 2 },
  ...
  popularItem: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#fff', borderRadius: 14, padding: 14, marginBottom: 8, gap: 12, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpa