    ...
    <div className="v0-page">
      <div className="v0-card">
        ...
        <p className="v0-texte">
          EchoTalk arrive : un espace pensé pour être entendu, pas pour être vu. Ni likes, ni followers, ni mise en scène de soi — seulement des expériences partagées, une résonance humaine, et la transmission de ce que la vie nous apprend.
        </p>
